...
// 参考地址：https://gallery.echartsjs.com/editor.html?c=xfQHKpD-Nv
...
export default {
  ...
  methods: {
    initChart() {
      ...
      const chartValue = this.chartValue;
      const option = {
        title: {
          text: this.title,
          bottom: "32%",
            ...
            data: [
              ...
              },
              {
                ...
                label: {
                  ...
                  borderRadius: 15 * this.scale,
                  padding: 10 * this.scale
                }
              },
              {
                //画剩余的刻度圆环
                name: "",
                value: this.maxValue - this.chartValue,
                label: {
                  show: false
                },
                labelLine: {
